 ...
 */
public class FDP_VOLUMES_DEFINITION_Model extends PointModel {
    ...
    public FDP_VOLUMES_DEFINITION_Model() {
        // 设置默认样式
        type.addListener((obs, oldVal, newVal) -> setDefaultStyle(newVal));
    }

    public FDP_VOLUMES_DEFINITION_Model(String name, AirspaceType type) {
        this();
        this.name.set(name);
        this.type.set(type);
    ...
    public ObjectProperty<AirspaceType> typeProperty() {
        return type;
    }
    ...
    public ObservableList<CoordinatePoint> getPoints() {
        return points;
    }
    ...
    public ObjectProperty<javafx.scene.paint.Color> fillColorProperty() {
        return fillColor;
    }
    ...
    public ObjectProperty<javafx.scene.paint.Color> strokeColorProperty() {
        return strokeColor;
    }
